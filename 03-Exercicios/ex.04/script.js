...
/* Escreva um programa em Javascript que realize três comparações com boolean. Realize uma comparação utilizando o operador maior que (>) para comparar 12 e 5, outra comparação utilizando o operador menor ou igual (<=) para comparar 4 e 4, e por fim, uma comparação utilizando o operador de diferença (!=) para comparar as strings "Jorge" e "João".
